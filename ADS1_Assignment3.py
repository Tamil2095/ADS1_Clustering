# -*- coding: utf-8 -*-
"""
Created on Thu Jan 18 12:18:01 2024
...
def read_and_filter_data(file_path, indicator1, indicator2, year):
    ...
    transpose_data = filtered_data.transpose()
    transpose_data.columns = transpose_data.iloc[0]
    transpose_data = transpose_data.iloc[1:]
    return filtered_data, transpose_data
...
data_2000, tran_data_2000 = read_and_filter_data(file_path, indicator1,
                                                 indicator2, year_2000)
data_2020, tran_data_2020 = read_and_filter_data(file_path, indicator1,
                                                 indicator2, year_2020)
